...
import {selectIsAuditRunning, selectAuditProgress, selectCurrentTest} from '../slices/audit';
	...
	return (
		<div className="AuditProgress">
			...
			<div className="AuditProgress-info">
				...
				{currentTest && (
					<span className="AuditProgress-test">
						{currentTest}
					</span>
				)}
			</div>
			...
			<div style={{fontSize: '12px', color: '#666', marginTop: '10px'}}>
				Debug: {isRunning ? 'En cours' : 'Arrêté'} | 
				Progression: {progress.current}/{progress.total} | 
				Test actuel: {currentTest || 'Aucun'}
			</div>
		</div>
	);
};
