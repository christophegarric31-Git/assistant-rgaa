...
Cette fonctionnalité ajoute un système d'audit automatique à l'extension
Assistant RGAA, permettant de vérifier automatiquement la conformité des pages
web selon le référentiel RGAA.
...
- **Détails** : Affichage des vérifications individuelles avec messages
  explicatifs
...
- Détermination du contexte sémantique ("porteuse d'information" vs
  "décorative")
...
2. **Suivre la progression** : Observer la barre de progression et le test en
   cours
3. **Consulter les résultats** : Ouvrir les instructions des tests pour voir les
   résultats détaillés
